...
function fetchCituroData(){return __awaiter(this,void 0,void 0,function*(){if(thisScriptElement){var a=thisScriptElement.getAttribute("data-user-account");const c=thisScriptElement.getAttribute("data-limit"),e=thisScriptElement.getAttribute("data-surrounding-element-id");if(a&&e){const b=document.getElementById(e);if(b){a=`https://app.cituro.com/api/ratings/${a}?limit=${c}&sort=-createdAt&filter[comment]=!null`;console.log(`calling ${a}`);a=yield fetch(a);if(!a.ok)throw console.log(b),new CannotFetchDataError({message:a.statusText,
